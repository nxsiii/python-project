...
# 3. Connexion au serveur (Utilisation du 'with' pour la propreté)
with smtplib.SMTP(SMTP_SERVER, SMTP_PORT) as smtp:
    ...
    for index, row in df.iterrows():
        ...
        time.sleep(15)
        # Création du message (Syntaxe moderne EmailMessage)
        msg = EmailMessage()
